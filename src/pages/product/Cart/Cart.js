            ...
            <tbody>
              {matchedItems.map((item) => (
                <tr key={item.id}>
                        ...
                        <React.Fragment>
                          <td>
                            <div className='button-container'>
                                <button className='crease' onClick={() => handleIncrease(item.id)}><VscAdd /></button>
                                <input className='count' type='number' value={cartItem.count} readOnly/>
                                <button className='crease dercrease' onClick={() => handleDecrease(item.id)}><VscChromeMinimize /></button>
                            </div>
                            </td>
                  ...
                  <td ><MdClear className="pointer"/></td>
                </tr>
              ))}
            </tbody>
          </table>
