...
function ViewProduct() {
    ...
    const filteredData = checked.length === 0 ? data : data.filter((shoes) => {
        return checked.some((index) => data[index].directory === shoes.directory);
    });
        ...
        <ViewListItem>
            ...
            <div className='viewList'>
                <div className='viewItem'>
                    ...
                    const isDuplicate = data.slice(0, index).some(item => item.directory === decroty.directory);
                ...
                <div className='itemProduct'>
                    <div className='line-divider'><h1 >Danh sách sản phẩm</h1></div>
                        <div className='product'>
                        <ul>
                            {currentProducts.map(shoes => (
                            <li className='itemShoes' onClick={() => {handleNavigate(shoes.id)}} key={shoes.id}>
